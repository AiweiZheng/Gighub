...
namespace GigHub.Tests.Persistence.Repositories
{
    ...
    public class GigRepositoryTests
    {
        ...
        [TestMethod]
        public void GetGigsUserAttending_AttendanceIsNotForTheGivenUser_ShouldNotBeReturned()
        {
            var attendeeId = "1";
        ...
        [TestMethod]
        public void GetGigsUserAttending_AttendanceIsForTheGivenUser_ShouldBeReturned()
        {
            var attendeeId = "1";
